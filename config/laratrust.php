...
return [
    ...
    */
    'models' => [
        ...
        'role' => \App\Models\InternalUserRole::class,

        'permission' => \App\Models\RolePermission::class,
    ...
    */
    'tables' => [
        ...
        'role_user' => 'internal_users_has_internal_user_roles',

        'permission_user' => 'internal_users_has_internal_user_roles',

        'permission_role' => 'internal_user_roles_has_role_permissions',
    ],
    ...
    */
    'foreign_keys' => [
         ...
         */
        'user' => 'internal_users_id',

        /**
         * Role foreign key on Laratrust's role_user and permission_role tables.
         */
        'role' => 'internal_user_roles_id',
